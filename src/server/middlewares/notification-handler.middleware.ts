...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'menu.create': { roles: ['owner'], key: 'menu-item-added', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'menu.update': { roles: ['owner'], key: 'menu-item-updated', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'menu.delete': { roles: ['owner'], key: 'menu-item-deleted', tenantPath: ['restaurant', 'menu'], userPath: [] },
};
